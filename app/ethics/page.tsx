...
export default function PublicationEthicsPage() {
  const [expandedSection, setExpandedSection] = useState<string | null>('authorship');
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mb-4">
            ATGHJ is committed to upholding the highest standards of research integrity and publication ethics. 
            We follow the guidelines established by the Committee on Publication Ethics (COPE), International 
            Committee of Medical Journal Editors (ICMJE), and World Association of Medical Editors (WAME).
          </p>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="max-w-3xl mx-auto bg-gradient-to-r from-primary/10 to-accent/10 border border-primary/20 rounded-lg p-8 mb-12">
          ...
          <p className="text-gray-700 leading-relaxed">
            As an open-access journal bridging research, innovation, and health equity in Africa, ATGHJ maintains 
            unwavering commitment to publication ethics. We ensure that all published research is original, scientifically 
            sound, and conducted with appropriate ethical oversight. Our rigorous peer review process, combined with 
            proactive plagiarism detection and misconduct investigation, protects the integrity of scientific publishing 
            while advancing knowledge for global health benefit.
          </p>
        </div>
      </div>
                          ...
                          <div key={idx} className="bg-white p-5 rounded-lg border border-gray-200">
                            ...
                            <ul className="space-y-2">
                              {subsection.points.map((point, pointIdx) => (
                                <li key={pointIdx} className="flex gap-3 text-gray-700 text-sm">
      ...
      <div className="bg-white border-t border-gray-200 py-12">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-8">Standards & Guidelines We Follow</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={idx} className="border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
                <div className="text-2xl font-bold text-accent mb-2">{standard.acronym}</div>
      ...
      <div className="bg-white border-t border-gray-200 py-12">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-2xl font-bold text-gray-900 mb-6">Reporting Ethical Concerns</h2>
            <p className="text-gray-700 mb-6">
              If you suspect a research misconduct or ethical violation, please report it confidentially to our 
              Editorial Office. All reports are taken seriously and investigated thoroughly.
            </p>
      ...
      <div className="bg-gradient-to-r from-accent to-accent/90 text-white py-12">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-3xl font-bold mb-4">Committed to Ethical Excellence</h2>
            <p className="text-lg opacity-90 mb-8 max-w-2xl mx-auto">
              By publishing with ATGHJ, you join a community dedicated to research integrity, transparency, 
              and advancing global health equity through ethical science.
            </p>
